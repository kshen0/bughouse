...
(function() {
  var A, B, C, COLORS, D, E, F, G, H, board, boardSquares, calculateThreat, canvas, createBoard, createRectangle, drawPieces, endSquare, init, isObstructed, moveSuccess, playerColor, sendMove, serverBaseUrl, sessionId, setSquareColorForImg, socket, squareSize, startSquare, startX, startY, toggleTurn, whitesTurn;
