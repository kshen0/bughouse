...
(function() {
  var COLORS, ChessGame, createGames, games, init, playerGameNum, serverBaseUrl, sessionId, socket, squareSize,
  ...
  createGames = function(playerInfo) {
    var canvas, gameId, playerColor, _i, _len, _ref, _results;
